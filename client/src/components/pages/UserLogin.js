...
function UserLogin() {
    return (
        <div
            ...
            <div className="w-2/5 h-1/2 bg-gray-700 rounded-lg shadow-lg flex flex-row gap-20">
                <div className="flex flex-col">
                 ...
                 whitespace-nowrap"> Log in
                        ...
                        <Link to="/register">
                            <label className="hover:text-discord_blurple text-discord_blurple cursor-pointer focus:outline-none"> Register </label>
                        </Link>
                        </div>
                    </form>
                </div>
                <div className="pt-16 pr-16">
                    ...
                    <div>
                        <h1 className="font-extrabold text-2xl pt-10 flex text-center text-gray-200"> Log in with QR
                            Code </h1>
                        <h2 className="pt-5 flex text-center text-gray-200"> Scan this with the Discord mobile app to
                            log in instantly</h2>
                    </div>
                </div>
