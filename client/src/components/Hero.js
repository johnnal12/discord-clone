            ...
            <div
                ...
                <div className="p-7 py-40 h-screen:scale-100 md:flex relative">
                    <div className="flex flex-col gap-7 md:max-w-md lg:max-w-none">
                        <h1 className="text-7xl font-extrabold items-center justify-center text-white"> IMAGINE A PLACE...</h1>
                        <h2 className="text-lg font-semibold tracking-wide lg:max-w-3xl w-full text-center text-white items-center">...where you
